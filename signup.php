...
if($_SERVER['REQUEST_METHOD']=='POST' && isset($_POST['signup-submit']))
{
    ...
    {
        echo 'user type is empty';
        exit;
    }
    else
    {
        
        $check_sql="select id, name, mobile, email, user_type from users where email='{$email}' or mobile='{$mobile}'";
        $check_result=mysqli_query($con, $check_sql);
        
        if(mysqli_num_rows($check_result)==0)
        {
            $sql="INSERT INTO users (name, mobile, email, password, user_type) values('{$fullname}', '{$mobile}', '{$email}', '{$password}', '{$user_type}')";
            ...
            {
                echo '<script>alert("Could Not Register the User, Please Try Again!");</script>';
            }
        }
        else
        {
...
<body>
    <div class="container">
        <div class="login-card-container">
            ...
            <form action="" method="POST" class="login-card" onsubmit="return validateSignUpForm()" >
    ...
    <script>
        function validateSignUpForm()
        {
            ...
            console.log(fullname, mobile, email, password, confirm_password, user_type);
